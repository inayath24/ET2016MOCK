...
public class WebHttpSessionRequestCacheUnitTest
{
	...
	public void testCalcRedirectUrlWithEncodingAttrs()
	{
		assertEquals(
				"/",
				executeCalculateRelativeRedirectUrl("electronics/en", "/sapbasketstorefront/electronics/en",
						"https://electronics.local:9002/sapbasketstorefront/electronics/en"));
		assertEquals(
				"/",
				executeCalculateRelativeRedirectUrl("electronics/en", "/sapbasketstorefront/electronics/en",
						"https://electronics.local:9002/sapbasketstorefront/electronics/en/"));
	...
	public void testCalcRedirectUrlWithMismatchEncodingAttrs()
	{
		assertEquals(
				"electronics/en",
				executeCalculateRelativeRedirectUrl("electronics/ja/Y/Z", "/sapbasketstorefront/electronics/ja/Y/Z",
						"https://electronics.local:9002/sapbasketstorefront/electronics/en"));
		assertEquals(
				"/",
				executeCalculateRelativeRedirectUrl("electronics/ja/Y/Z", "/sapbasketstorefront/electronics/en",
						"https://electronics.local:9002/sapbasketstorefront/electronics/en/"));
	}
	...
	public void testCalcRedirectUrlWithoutEncodingAttrs()
	{
		assertEquals(
				"/",
				executeCalculateRelativeRedirectUrl("", "/sapbasketstorefront",
						"https://electronics.local:9002/sapbasketstorefront"));
		assertEquals(
				"/",
				executeCalculateRelativeRedirectUrl("", "/sapbasketstorefront",
						"https://electronics.local:9002/sapbasketstorefront/"));
	...
	public void testCalcRedirectUrlWithEncodingAttrsServletPath()
	{
		assertEquals(
				...
				executeCalculateRelativeRedirectUrl("electronics/en", "/sapbasketstorefront/electronics/en",
						"https://electronics.local:9002/sapbasketstorefront/electronics/en/Open-Catalogue/Cameras/Digital-Cameras/c/575"));
	}
