 ...
 */
package com.sap.sapbasket.fulfilmentprocess.test.actions;
...
public class SplitOrder extends TestActionTemp
{
	...
	public String execute(final BusinessProcessModel process) throws Exception //NOPMD
	{
		...
		warehouseCounter.setName(SapbasketFulfilmentProcessConstants.CONSIGNMENT_COUNTER);
		...
		params.setName(SapbasketFulfilmentProcessConstants.PARENT_PROCESS);
