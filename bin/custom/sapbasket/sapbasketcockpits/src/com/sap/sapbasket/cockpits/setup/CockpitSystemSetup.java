 ...
 */
package com.sap.sapbasket.cockpits.setup;
...
import com.sap.sapbasket.cockpits.constants.SapbasketCockpitsConstants;
 ...
 */
@SystemSetup(extension = SapbasketCockpitsConstants.EXTENSIONNAME)
public class CockpitSystemSetup extends AbstractSystemSetup
{
	...
	public void createEssentialData(final SystemSetupContext context)
	{
		...
		{
			if (MediaManager.getInstance().getMediaFolderByQualifier(SapbasketCockpitsConstants.JASPER_REPORTS_MEDIA_FOLDER).size() < 1)
			{
				MediaManager.getInstance().createMediaFolder(SapbasketCockpitsConstants.JASPER_REPORTS_MEDIA_FOLDER,
						SapbasketCockpitsConstants.JASPER_REPORTS_MEDIA_FOLDER);
			}
			try
			{
				String prefix = null;
				...
				if (prefix != null){
					importImpexFile(context, "/sapbasketcockpits/reportcockpit/import/" + prefix + "_jasperreports.impex");
				}
			}
