 ...
 *
 */
package com.sap.sapbasket.core.event;
 ...
 *
 */
public class UpdateProfileEventListener extends AbstractAcceleratorSiteEventListener<UpdateEvent>
{
	 ...
	 */
	@Override
	protected SiteChannel getSiteChannelForEvent(final UpdateEvent event)
	{
	 ...
	 */
	@Override
	protected void onSiteEvent(final UpdateEvent updateEvent)
	{
		final StoreFrontCustomerProcessModel storeFrontCustomerProcessModel = (StoreFrontCustomerProcessModel) getBusinessProcessService()
				.createProcess(
						"customerUpdateProfileEmailProcess-" + updateEvent.getCustomer().getUid() + "-" + System.currentTimeMillis(),
