 ...
 */
package com.sap.sapbasket.test.setup;
...
import com.sap.sapbasket.test.constants.SapbasketTestConstants;
import com.sap.sapbasket.test.orders.AcceleratorTestOrderData;
 ...
 */
@SystemSetup(extension = SapbasketTestConstants.EXTENSIONNAME)
public class TestDataSystemSetup extends AbstractSystemSetup
{
	...
	public void createProjectData(final SystemSetupContext context)
	{
		if (getBooleanSystemSetupParameter(context, CREATE_TEST_DATA))
		{
			...
			importImpexFile(context, "/sapbaskettest/import/qa-test-users.impex");

			LOG.info("Creating Reviews...");
			importImpexFile(context, "/sapbaskettest/import/reviews.impex");
			...
			importImpexFile(context, "/sapbaskettest/import/cstickets.impex");
		}
	}
}
