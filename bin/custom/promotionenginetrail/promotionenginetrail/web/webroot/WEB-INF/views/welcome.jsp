...
<div class="container">
    ...
    <div>
        ...
        <ul>
            <li><b>resources/promotionenginetrail-items.xml</b> - here you can model your items</li>
            <li><b>resources/promotionenginetrail-spring.xml</b> - here you can define your services</li>
            <li><b>web/webroot/WEB-INF/config/promotionenginetrail-spring-mvc-config.xml</b> - here is a Spring MVC related
                configuration
            </li>
            <li><b>web/webroot/WEB-INF/config/promotionenginetrail-web-app-config.xml</b> - here you can define web related services,
                facades etc.
            </li>
            <li><b>web/webroot/WEB-INF/config/promotionenginetrail-spring-security-config.xml</b> - here you can configure your Spring Security settings</li>
